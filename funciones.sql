...
/
---- funcion que obtiene el nombre del proyecto con más tareas
...
--- Funcion que obtiene la tarea más cercana a su fecha límite
...
-- Funcion que obtiene la fecha más importante en el calendario
...
-- Funcion que obtiene el estado más común de las tareas
