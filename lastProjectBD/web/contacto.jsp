    ...
    <body>
        ...
        <div class="card-container">
            <div class="card shadow">
                <h2>Correo</h2>
                <p>Envíanos un mensaje a <strong>contacto@CONDINGRAPH;.com</strong></p>
            </div>
            <div class="card shadow">
                <h2>Teléfono</h2>
                <p>Llámanos al <strong>+506 1111-1111</strong></p>
            </div>
            <div class="card shadow">
                <h2>Ubicación</h2>
                <p>Visítanos en <strong>Av. Principal, Ciudad</strong></p>
            </div>
        </div>
