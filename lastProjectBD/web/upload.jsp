...
<html lang="es">
    <head>
        ...
        <title>Centro de Subida de Archivos</title>
    ...
    <body>
        ...
        <main class="main-content">
            <section class="intro">
                <h1>Centro de Subida de Archivos</h1>
                <p>Sube tus archivos de forma rápida, segura y sencilla.</p>
                <p class="info">Formatos permitidos: <strong>PDF, JPG, DOCX</strong> | Tamaño máximo: <strong>10 MB</strong></p>
            </section>
        ...
        <footer>
            ...
            <div class="footerMenu">
                ...
                <nav class="menuFooter">
                    <ul>
                        <li><a href="addUsers.jsp">Agregar Usuarios</a></li>
                        <li><a href="addCostumers.jsp">Agregar Clientes</a></li>
                        <li><a href="addSuppliers.jsp">Agregar Proveedores</a></li>
                    </ul>
